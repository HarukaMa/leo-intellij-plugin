...
public class LeoConjunctiveExpressionImpl extends LeoExpressionImpl implements LeoConjunctiveExpression {

  public LeoConjunctiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitConjunctiveExpression(this);
  }
