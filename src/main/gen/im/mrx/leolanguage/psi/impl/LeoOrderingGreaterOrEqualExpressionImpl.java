...
public class LeoOrderingGreaterOrEqualExpressionImpl extends LeoExpressionImpl implements LeoOrderingGreaterOrEqualExpression {

  public LeoOrderingGreaterOrEqualExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitOrderingGreaterOrEqualExpression(this);
  }
