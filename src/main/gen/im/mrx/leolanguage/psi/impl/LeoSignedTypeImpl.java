...
public class LeoSignedTypeImpl extends ASTWrapperPsiElement implements LeoSignedType {

  public LeoSignedTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitSignedType(this);
  }
