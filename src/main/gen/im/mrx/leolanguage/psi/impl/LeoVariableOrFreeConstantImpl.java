...
public class LeoVariableOrFreeConstantImpl extends ASTWrapperPsiElement implements LeoVariableOrFreeConstant {

  public LeoVariableOrFreeConstantImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitVariableOrFreeConstant(this);
  }
