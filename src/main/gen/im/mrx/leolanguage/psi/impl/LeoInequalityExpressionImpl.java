...
public class LeoInequalityExpressionImpl extends LeoExpressionImpl implements LeoInequalityExpression {

  public LeoInequalityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
