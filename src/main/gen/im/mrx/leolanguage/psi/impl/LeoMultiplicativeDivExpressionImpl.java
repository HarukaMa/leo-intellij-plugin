...
public class LeoMultiplicativeDivExpressionImpl extends LeoExpressionImpl implements LeoMultiplicativeDivExpression {

  public LeoMultiplicativeDivExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitMultiplicativeDivExpression(this);
  }
