...
public class LeoAssertEqualCallImpl extends ASTWrapperPsiElement implements LeoAssertEqualCall {

  public LeoAssertEqualCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitAssertEqualCall(this);
  }
