...
public class LeoAssignmentOperatorImpl extends ASTWrapperPsiElement implements LeoAssignmentOperator {

  public LeoAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
