...
public class LeoAssertCallImpl extends ASTWrapperPsiElement implements LeoAssertCall {

  public LeoAssertCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitAssertCall(this);
  }
