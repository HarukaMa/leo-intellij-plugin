...
public class LeoShiftLeftExpressionImpl extends LeoExpressionImpl implements LeoShiftLeftExpression {

  public LeoShiftLeftExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitShiftLeftExpression(this);
  }
