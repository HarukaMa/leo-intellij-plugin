...
public class LeoUnaryMinusExpressionImpl extends LeoExpressionImpl implements LeoUnaryMinusExpression {

  public LeoUnaryMinusExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
