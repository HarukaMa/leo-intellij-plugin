...
public class LeoExponentialExpressionImpl extends LeoExpressionImpl implements LeoExponentialExpression {

  public LeoExponentialExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
