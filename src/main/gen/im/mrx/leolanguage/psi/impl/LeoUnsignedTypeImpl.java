...
public class LeoUnsignedTypeImpl extends ASTWrapperPsiElement implements LeoUnsignedType {

  public LeoUnsignedTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitUnsignedType(this);
  }
