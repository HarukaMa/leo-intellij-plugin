...
public class LeoAssignmentStatementImpl extends ASTWrapperPsiElement implements LeoAssignmentStatement {

  public LeoAssignmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LeoAssignmentOperator getAssignmentOperator() {
    return findNotNullChildByClass(LeoAssignmentOperator.class);
  }
