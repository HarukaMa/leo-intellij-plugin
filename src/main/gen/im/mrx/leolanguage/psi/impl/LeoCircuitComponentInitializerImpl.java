...
public class LeoCircuitComponentInitializerImpl extends ASTWrapperPsiElement implements LeoCircuitComponentInitializer {

  public LeoCircuitComponentInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitCircuitComponentInitializer(this);
  }
