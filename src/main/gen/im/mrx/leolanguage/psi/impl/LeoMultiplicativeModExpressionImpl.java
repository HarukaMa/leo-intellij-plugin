...
public class LeoMultiplicativeModExpressionImpl extends LeoExpressionImpl implements LeoMultiplicativeModExpression {

  public LeoMultiplicativeModExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitMultiplicativeModExpression(this);
  }
