...
public class LeoOrderingGreaterExpressionImpl extends LeoExpressionImpl implements LeoOrderingGreaterExpression {

  public LeoOrderingGreaterExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitOrderingGreaterExpression(this);
  }
