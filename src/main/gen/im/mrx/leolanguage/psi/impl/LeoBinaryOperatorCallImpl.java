...
public class LeoBinaryOperatorCallImpl extends LeoExpressionImpl implements LeoBinaryOperatorCall {

  public LeoBinaryOperatorCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitBinaryOperatorCall(this);
  }
