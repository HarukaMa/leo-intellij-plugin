...
public class LeoConditionalTernaryExpressionImpl extends LeoExpressionImpl implements LeoConditionalTernaryExpression {

  public LeoConditionalTernaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitConditionalTernaryExpression(this);
  }
