...
public class LeoGroupCoordinateImpl extends ASTWrapperPsiElement implements LeoGroupCoordinate {

  public LeoGroupCoordinateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitGroupCoordinate(this);
  }
  ...
  public PsiElement getNumeral() {
    return findChildByType(NUMERAL);
  }
