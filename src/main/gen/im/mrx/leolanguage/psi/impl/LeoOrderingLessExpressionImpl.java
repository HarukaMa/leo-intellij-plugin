...
public class LeoOrderingLessExpressionImpl extends LeoExpressionImpl implements LeoOrderingLessExpression {

  public LeoOrderingLessExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitOrderingLessExpression(this);
  }
