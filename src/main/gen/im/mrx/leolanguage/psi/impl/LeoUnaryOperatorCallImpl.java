...
public class LeoUnaryOperatorCallImpl extends LeoExpressionImpl implements LeoUnaryOperatorCall {

  public LeoUnaryOperatorCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitUnaryOperatorCall(this);
  }
