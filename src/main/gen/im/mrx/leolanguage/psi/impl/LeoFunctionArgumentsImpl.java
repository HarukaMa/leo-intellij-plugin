...
public class LeoFunctionArgumentsImpl extends ASTWrapperPsiElement implements LeoFunctionArguments {

  public LeoFunctionArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
