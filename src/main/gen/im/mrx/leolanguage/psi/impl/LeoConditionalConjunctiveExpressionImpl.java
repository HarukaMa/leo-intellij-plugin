...
public class LeoConditionalConjunctiveExpressionImpl extends LeoExpressionImpl implements LeoConditionalConjunctiveExpression {

  public LeoConditionalConjunctiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitConditionalConjunctiveExpression(this);
  }
