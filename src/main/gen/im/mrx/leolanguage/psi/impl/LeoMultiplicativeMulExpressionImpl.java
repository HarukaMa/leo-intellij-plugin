...
public class LeoMultiplicativeMulExpressionImpl extends LeoExpressionImpl implements LeoMultiplicativeMulExpression {

  public LeoMultiplicativeMulExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitMultiplicativeMulExpression(this);
  }
