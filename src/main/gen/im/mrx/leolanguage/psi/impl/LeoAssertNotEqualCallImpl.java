...
public class LeoAssertNotEqualCallImpl extends ASTWrapperPsiElement implements LeoAssertNotEqualCall {

  public LeoAssertNotEqualCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitAssertNotEqualCall(this);
  }
