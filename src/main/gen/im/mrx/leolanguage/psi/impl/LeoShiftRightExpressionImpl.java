...
public class LeoShiftRightExpressionImpl extends LeoExpressionImpl implements LeoShiftRightExpression {

  public LeoShiftRightExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitShiftRightExpression(this);
  }
