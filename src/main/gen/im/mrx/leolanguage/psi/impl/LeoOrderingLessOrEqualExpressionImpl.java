...
public class LeoOrderingLessOrEqualExpressionImpl extends LeoExpressionImpl implements LeoOrderingLessOrEqualExpression {

  public LeoOrderingLessOrEqualExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitOrderingLessOrEqualExpression(this);
  }
