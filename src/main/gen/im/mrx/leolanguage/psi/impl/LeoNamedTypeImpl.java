...
public class LeoNamedTypeImpl extends ASTWrapperPsiElement implements LeoNamedType {

  public LeoNamedTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public LeoPrimitiveType getPrimitiveType() {
    return findChildByClass(LeoPrimitiveType.class);
  }
