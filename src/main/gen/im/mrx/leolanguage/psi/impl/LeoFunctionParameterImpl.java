...
public class LeoFunctionParameterImpl extends ASTWrapperPsiElement implements LeoFunctionParameter {

  public LeoFunctionParameterImpl(@NotNull ASTNode node) {
    super(node);
  }
