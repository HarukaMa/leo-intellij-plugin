...
public class LeoAdditiveAddExpressionImpl extends LeoExpressionImpl implements LeoAdditiveAddExpression {

  public LeoAdditiveAddExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitAdditiveAddExpression(this);
  }
