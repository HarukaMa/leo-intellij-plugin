...
public class LeoConditionalDisjunctiveExpressionImpl extends LeoExpressionImpl implements LeoConditionalDisjunctiveExpression {

  public LeoConditionalDisjunctiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitConditionalDisjunctiveExpression(this);
  }
