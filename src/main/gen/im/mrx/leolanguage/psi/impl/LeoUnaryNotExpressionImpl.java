...
public class LeoUnaryNotExpressionImpl extends LeoExpressionImpl implements LeoUnaryNotExpression {

  public LeoUnaryNotExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
