...
public class LeoEqualityExpressionImpl extends LeoExpressionImpl implements LeoEqualityExpression {

  public LeoEqualityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
