...
public class LeoExclusiveDisjunctiveExpressionImpl extends LeoExpressionImpl implements LeoExclusiveDisjunctiveExpression {

  public LeoExclusiveDisjunctiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitExclusiveDisjunctiveExpression(this);
  }
