...
public class LeoRecordDeclarationImpl extends ASTWrapperPsiElement implements LeoRecordDeclaration {

  public LeoRecordDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
