...
public class LeoDisjunctiveExpressionImpl extends LeoExpressionImpl implements LeoDisjunctiveExpression {

  public LeoDisjunctiveExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull LeoVisitor visitor) {
    visitor.visitDisjunctiveExpression(this);
  }
