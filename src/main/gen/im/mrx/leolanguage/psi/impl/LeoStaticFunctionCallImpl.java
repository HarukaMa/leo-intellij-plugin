...
public class LeoStaticFunctionCallImpl extends ASTWrapperPsiElement implements LeoStaticFunctionCall {

  public LeoStaticFunctionCallImpl(@NotNull ASTNode node) {
    super(node);
  }
