...
public class LeoVariableDeclarationImpl extends ASTWrapperPsiElement implements LeoVariableDeclaration {

  public LeoVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
