...
LINE_COMMENT=\/\/[\u0000-\u0009\u000B-\u000C\u000E-\u007F\u0080-\u2029\u202F-\u2065\u2070-\uD7FF\uE000-\uFFFF]*
BLOCK_COMMENT=\/[*]([^*]|[*][^/])*([*]\/)?
KEYWORD=address|async|block|bool|console|constant|else|field|finalize|for|function|group|i8|i16|i32|i64|i128|if|import|in|inline|let|mapping|private|program|public|record|return|scalar|self|struct|then|transition|u8|u16|u32|u64|u128
