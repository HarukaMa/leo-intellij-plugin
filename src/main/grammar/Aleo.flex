...
LINE_COMMENT=\/\/.*
BLOCK_COMMENT=\/[*]([^*]|[*][^/])*([*]\/)?
KEYWORD=import|program|interface|record|function|closure|into|as|field|group|scalar|u8|u16|u32|u64|u128|i8|i16|i32|i64|i128|address|boolean|string|increment|decrement|finalize|mapping|key|value
